  ...
  <body>
    ...
    <div class="d-flex align-items-center justify-content-center bg-sl-primary ht-100v" id="maintenance">
      ...
      <div style="width: 30%;" class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white">
        <div class="signin-logo tx-center tx-24 tx-bold tx-inverse">Autorisation<span class="tx-info tx-normal"></span></div>
        ...
        <div style="text-align: center;" class="form-group">
           ...
           <h2 style="text-align: center;" class="btn btn-info">Vous n'êtes autorisés.....</h2>
